...
export type BridgeDescribeResult = { ok: true; value: { namespaces: BridgeNamespaceView[]; writable: boolean } } | { ok: false; code: string; message: string };
...
export type BridgeMutateResult = { ok: true; value: BridgeNamespaceView } | { ok: false; code: string; message: string };
